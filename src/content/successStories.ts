...
export const SUCCESS_STORIES: SuccessStory[] = [
  {
    ...
    featuredImage: '/assets/images/projects/coffee-mine-cover.webp',
    accentColor: '#C9A56A',
    status: 'PUBLISHED',
    displayOrder: 1,
  ...
  },
  {
    ...
    featuredImage: '/assets/images/projects/go-chicken-landing.webp',
    accentColor: '#E6D3A3',
    status: 'PUBLISHED',
    displayOrder: 2,
  ...
  },
  {
    ...
    featuredImage: '/assets/images/projects/gym-bolt-cover.webp',
    accentColor: '#C9A56A',
    status: 'PUBLISHED',
    displayOrder: 3,
