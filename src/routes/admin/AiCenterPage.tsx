    ...
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      <div className="p-8 rounded-3xl bg-white/85 backdrop-blur-xl border border-[#C9A56A]/30 shadow-[0_8px_30px_rgba(11,48,39,0.06)] space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <input
            type="url"
            defaultValue="https://cafevistaara.com"
          ...
          />
          <button className="px-6 py-3.5 rounded-full bg-[#0B3027] hover:bg-[#0E3A2F] text-white font-semibold text-xs shadow-[0_4px_16px_rgba(11,48,39,0.25)] transition-all">
            Execute ScoutAI Scan →
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 pt-4">
          <div className="p-5 rounded-2xl bg-[#F8F6F1] border border-[#0B3027]/10 space-y-1.5 shadow-sm">
            ...
            <div className="text-xs text-emerald-700 font-mono font-bold">PASSED (Contrast ≥ 4.5:1)</div>
          </div>
          <div className="p-5 rounded-2xl bg-[#F8F6F1] border border-[#0B3027]/10 space-y-1.5 shadow-sm">
            <div className="text-[10px] font-mono font-bold text-[#9A7B4F]">
              TELEMETRY MODULE 2
            ...
            <div className="text-xs text-emerald-700 font-mono font-bold">SCORE: 98/100 (FCP 0.6s)</div>
          </div>
          <div className="p-5 rounded-2xl bg-[#0B3027] text-[#F8F6F1] border border-[#C9A56A]/30 space-y-1.5 shadow-md">
            ...
            <div className="text-xs text-[#C9A56A] font-mono font-bold">READY TO GENERATE</div>
          </div>
        </div>
      </div>
    </div>
