-- ==============================================================================
-- MIGRATION: 0049_fix_organization_members_role.sql
-- PURPOSE: Safely add role column to organization_members and workspace_members,
-- and update convert_lead_to_workspace RPC.
-- Resolves error 42703 ("column 'role' of relation 'organization_members' does not exist").
-- ==============================================================================

BEGIN;

-- 1. Add role column safely to organization_members and workspace_members
...
-- 2. Update convert_lead_to_workspace RPC
